...
5. Context-menu behavior must not regress from the current repository baseline.

## Explicit Non-Goals

- No new custom accessibility gesture model
- No product-scope expansion into redesigned context menus or new shortcuts unless required solely to preserve existing behavior after the List migration
