...
enum UITestAppLauncher {
    ...
    static let rowActionScenarioBSeedReadinessFileArgument = "-ui-test-row-action-scenario-b-seed-readiness-file"
    static let rowActionScenarioBSeedReadinessRunIDArgument = "-ui-test-row-action-scenario-b-seed-readiness-run-id"
